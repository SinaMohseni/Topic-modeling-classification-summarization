...
./bin/mallet train-topics --input $2/text.mallet --output-model $2/mallet_model.mm --output-state $2/state.txt.gz --output-topic-keys $2/keys.txt --xml-topic-phrase-report $2/phrases.xml --output-doc-topics $2/doc_topics.txt --num-threads 4 --num-topics $3 --num-top-words 200
cd ..
